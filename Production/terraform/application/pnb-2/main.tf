...
module "helm" {
  ...
  ingress_nginx_pier_values_contents = [
    ...
    file("../../../helm/application/pernambucanas/values-ingress-nginx-pier.yaml"), //Changing HTTP Port to 6970
    file("../../../helm/azure/ingress/values-ingress-nginx-local.yaml")             //Ingress with Local IP
  ]
