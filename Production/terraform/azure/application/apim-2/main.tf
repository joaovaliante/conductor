...
data "azurerm_key_vault" "vault" {
  ...
  resource_group_name = "RG_FrontDoor"
}
...
module "apim-domain" {
  ...
  proxies = [{
    hostname         = "gateway-apim-2.conductor.com.br"
