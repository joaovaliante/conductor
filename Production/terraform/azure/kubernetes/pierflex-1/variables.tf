 ...
 /******************************************
	 Vnext-Geral
  *****************************************/
 variable "vnext_geral_machine_type" {
   type        = string
   description = "Vnext-geral machine type"
   default     = "Standard_F8s_v2"
 }
 
 variable "vnext_geral_min" {
   type        = number
   description = "Min Vnext-geral machines"
   default     = 3
 }
 
 variable "vnext_geral_max" {
   type        = number
   description = "Max Vnext-geral machines"
   default     = 10
 }
