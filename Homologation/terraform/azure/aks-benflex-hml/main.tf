...
module "kubernetes" {
  ...
  rancher_base_url         = "https://rancher-ben.devcdt.com.br/"
  ...
  node_pools = [{
    name               = "benflexpier",
    node_count         = var.benflex_hml_min,
    vm_size            = var.benflex_hml_machine_type,
    auto_scaling       = true
    min_count          = var.benflex_hml_min
    max_count          = var.benflex_hml_max
