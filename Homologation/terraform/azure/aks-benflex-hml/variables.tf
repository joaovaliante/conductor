...
/******************************************
	Vnext-Geral
 *****************************************/
variable "benflex_hml_machine_type" {
  type        = string
  description = "Bneflex HML machine type"
  default     = "Standard_F8s_v2"
}

variable "benflex_hml_min" {
  type        = number
  description = "Min Benflex HML machines"
  default     = 1
}

variable "benflex_hml_max" {
  type        = number
  description = "Max Benflex HML machines"
  default     = 10
}
